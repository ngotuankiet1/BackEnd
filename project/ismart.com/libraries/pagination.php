<?php
function get_paggings($num_page, $page)
{
...
#SEARCH
function get_pagging_search_all($num_page, $page, $value,$cat_id)
{
    $str_pagging = "<ul class='pagging fl-right' id='list-paging'>";
    $str_pagging .= "<li><a class='num-page-search' value='$value' cat-id= '$cat_id'><<</a></li>";
    for ($i = 1; $i <= $num_page; $i++) {
        $active = "";
        if ($page == $i) {
            $active = 'active';
        }
        $str_pagging .= "<li><a class='num-page-search $active' value='$value' cat-id= '$cat_id'>$i</a></li>";
    }
    $str_pagging .= "<li><a class='num-page-search' value='$value' cat-id= '$cat_id'>>></a></li>";
    $str_pagging .= "</ul>";
    return $str_pagging;
...
function get_pagging_all_blog($num_page, $page)
{
    $str_pagging = "<ul class='pagging fl-right' id='list-paging'>";
    $str_pagging .= "<li><a class='num-page-blog'><<</a></li>";
    for ($i = 1; $i <= $num_page; $i++) {
        $active = "";
        if ($page == $i) {
            $active = 'active';
        }
        $str_pagging .= "<li><a class='num-page-blog $active'>$i</a></li>";
    }
    $str_pagging .= "<li><a class='num-page-blog'>>></a></li>";
    $str_pagging .= "</ul>";
    return $str_pagging;
