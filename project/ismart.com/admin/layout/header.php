                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="?mod=product&controller=cat_product&action=index" title="">Danh mục sản phẩm</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="?mod=order&controller=customer&action=customer" title="">Danh sách khách hàng</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                            <button class="dropdown-toggle clearfix" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <h3 id="account" class="fl-right"> <?php echo $_SESSION['users_login']; ?> </h3>
                            </button>
                            <ul class="dropdown-menu">
                                <li><a href="?mod=users&action=info_admin" title="Thông tin cá nhân">Thông tin tài khoản</a></li>
