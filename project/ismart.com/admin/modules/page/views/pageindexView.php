...
#Tổng số bản ghi
$total_row = db_num_rows("SELECT* FROM  `tbl_page`");
...
/*=========================================================*/
//page đã phê duyệt
$total_approved = db_num_rows("SELECT* FROM  `tbl_page` Where `page_status`= 'Approved'");
//page chờ xét duyệt
$total_waiting = db_num_rows("SELECT* FROM  `tbl_page` Where `page_status`= 'Waitting...'");
//page trash
$total_strash = db_num_rows("SELECT* FROM  `tbl_page` Where `page_status`= 'Trash'");
?>
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=page&action=apply_page&page=<?php echo $page_num; ?>">
                        <div class="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    <ul id="list-paging-page_num" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page_num, "?mod=page&controller=index&action=index");
                        ?>
                    </ul>
                </div>
            </div>
