...
#Tổng số bản ghi
$total_row = db_num_rows("SELECT* FROM  `tbl_product_cat`");
...
$list_cat_product = array_slice($list_cat, $start, $num_per_page);
/*=========================================================*/
//page đã phê duyệt
$total_approved = db_num_rows("SELECT* FROM  `tbl_product_cat` Where `cat_status`= 'Approved'");
//page chờ xét duyệt
$total_waiting = db_num_rows("SELECT* FROM  `tbl_product_cat` Where `cat_status`= 'Waitting...'");
//page trash
$total_strash = db_num_rows("SELECT* FROM  `tbl_product_cat` Where `cat_status`= 'Trash'");
?>
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=product&controller=cat_product&action=add_cat_product" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=product&controller=cat_product&action=apply_page&page=<?php echo $page_num; ?>">
                        <div class="actions">
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    <div class="tb-title fl-left">
                                                        <a href="" title=""><?php echo str_repeat('--', $item['lever']) . ' ' . $item['title']; ?></a>
                                                    </div>
                                                    <ul class="list-operation fl-right">
                                                        ...
                                                        <li><a href="?mod=product&controller=cat_product&action=delete_cat&id_cat_product=<?php echo $item['cat_id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                </td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging-cat-product" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page_num,"?mod=product&controller=cat_product&action=index");
                        ?>
                    </ul>
                </div>
            </div>
