...
$lis_cat_post = array_slice($list_cat, $start, $num_per_page);
/*=========================================================*/
//page đã phê duyệt
$total_approved = db_num_rows("SELECT* FROM  `tbl_post_cat` Where `cat_status`= 'Approved'");
//page chờ xét duyệt
$total_waiting = db_num_rows("SELECT* FROM  `tbl_post_cat` Where `cat_status`= 'Waitting...'");
//page trash
$total_strash = db_num_rows("SELECT* FROM  `tbl_post_cat` Where `cat_status`= 'Trash'");
?>
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=post&controller=cat&action=apply_page&page=<?php echo $page_num; ?>">
                        <div class="actions">
                                            ...
                                            <tr>
                                                ...
                                                <td class="clearfix">
                                                    ...
                                                    <ul class="list-operation fl-right">
                                                        ...
                                                        <li><a href="?mod=post&controller=cat&action=delete_cat_post&id_cat_post=<?php echo $item['cat_id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                </td>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging-cat-post" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page_num,"?mod=post&controller=cat&action=index");
                        ?>
                    </ul>
                </div>
            </div>
