...
$get_list_customer = db_fetch_array("SELECT * FROM `tbl_customers` WHERE CONVERT(`fullname` USING utf8) LIKE '%{$value}%' OR `phone` LIKE '%{$value}%'");
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=order&controller=customer&action=apply_customer&page=<?php echo $page_num; ?>&value=<?php echo $value; ?>">
                        <div class="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging-customers" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page_num, "?mod=order&controller=customer&action=result_search");
                        ?>
                    </ul>
                </div>
            </div>
