        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=order&action=apply_order&page=<?php echo $num_page ?>">
                        <div class="actions">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($list_customer_page as $order) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="?mod=order&action=detail&order_id=<?php echo $order['id_order']; ?>" title="" class="tbody-text">Chi tiết</a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                <?php } else { ?>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging-customers" class="fl-right">
                        <?php
                        echo get_pagging($num_page, $page_num, "?mod=order");
                        ?>
                    </ul>
                </div>
            </div>
