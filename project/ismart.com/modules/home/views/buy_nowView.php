                ...
                <div class="section-detail">
                    <div class="form-row clearfix">
                        ...
                        <div class="form-col fl-right">
                            ...
                            <input type="email" name="email" id="email" <?php echo set_value("email"); ?>>
                        </div>
                    </div>
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            <label for="phone">Số điện thoại</label>
                            <input type="tel" name="phone" id="phone" <?php echo set_value("phone"); ?>>
            ...
            <div class="section" id="order-review-wp">
                ...
                <div class="section-detail">
                    <table class="shop-table">
                        ...
                        <tbody>
                            <tr class="cart-item">
                                <td class="product-name"><?php echo $product['product_name'] ?><strong class="product-quantity">x 1</strong></td>
                                <td class="product-total"><?php echo currency_format($product['price_new']); ?></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr class="order-total">
                                <td>Tổng đơn hàng:</td>
                                <td><strong class="total-price"><?php echo currency_format($product['price_new']); ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
