                            ...
                            <tbody>
                                <?php foreach ($list_cart as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="1" max="10" data_id="<?php echo $item['id']; ?>" name="qty[<?php echo $item['id'] ?>]" value="<?php echo $item['qty']; ?>" class="num_order">
                                        </td>
                                        <td id="total-<?php echo $item['id']; ?>"><?php echo arrency_format($item['sud_total']); ?></td>
                                        <td>
