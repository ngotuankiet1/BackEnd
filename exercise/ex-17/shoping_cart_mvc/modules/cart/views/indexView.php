    ...
    <div id="wrapper" class="wp-inner clearfix">
                    ...
                    <table class="table">
                            ...
                            <tbody>
                                <?php foreach ($product as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="1" max="10" data_id="<?php echo $item['id']; ?>" name="qty[<?php echo $item['id']; ?>]" value="<?php echo $item['qty'] ?>" class="num-order">
                                        </td>
                                        <td id="total-<?php echo $item['id']; ?>"><?php echo currency_format($item['sud_total']); ?></td>
                                        <td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7">
                                    <div class="clearfix">
                                        <p id="total-price" class="fl-right">Tổng giá: <span><?php echo $total; ?></span></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="section" id="action-cart-wp">
            <div class="section-detail">
                ...
                <a href="?mod=cart&action=alldelete" title="" id="delete-cart">Xóa giỏ hàng</a>
            </div>
        </div>
    </div>
</div>
