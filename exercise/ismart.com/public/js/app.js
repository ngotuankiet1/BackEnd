...
$(document).ready(function(){
    function get_data(cat_id, page_num){
        ...
        console.log(data);
        $.ajax({
            url: 'http://localhost:8080/unitop/back-end/project/ismart.com/?mod=product&controller=index&action=product_cat',
            method: 'POST',
            data: data,
            dataType: 'json',
...
$(document).ready(function () {
    $(".num-order").change(function () {
        ...
        // console.log(data);
        $.ajax({
            url: 'http://localhost:8080/unitop/back-end/project/ismart.com/?mod=cart&controller=index&action=update_cart',
            method: 'POST',
            data: data,
            dataType: 'json',
            success: function(data){
...
$(document).ready(function (){
    $(".province").change(function () {
        ...
        $.ajax({
            url: 'http://localhost:8080/unitop/back-end/project/ismart.com/?mod=cart&action=district',
            method: 'POST',
            data: data,
            dataType: 'text',
            success: function(data){
...
$(document).ready(function (){
    $(".district").change(function () {
        ...
        $.ajax({
            url: 'http://localhost:8080/unitop/back-end/project/ismart.com/?mod=cart&action=select_commune',
            method: 'POST',
            data: data,
            dataType: 'text',
            success: function(data){
